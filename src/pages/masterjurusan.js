...
import PopupJurusan from "./popupjurusan";
import TableMasterJurusan from "./tablemasterjurusan";
...
export default function MasterJurusan() {
  ...
  const fetchUserImport = async () => {
    if (selectedFile) {
      ...
      const resUserImport = await fetch(`${API_URL}/master/major/import`, {
        method: "POST",
        credentials: "include",
        headers: {
      ...
      <div className="bg-white pr-5 ml-[218px]">
        ...
        <div className="grid col-2 mt-[110px] space-y-[25px] mb-[35px]">
          <div className="flex items-center gap-3">
            <div className="text-base font-semibold ">Add Jurusan :</div>
            <PopupJurusan />
          </div>
          <div className="flex items-center gap-3">
